...
las 23 suites disponibles. Batería actual: núcleo **671/671** · aceptación 50/50 ·
...
captura lecturas acotadas vNEXT **9/9** · **22 scripts HTML**.
Detalle y límites de
verificación real en [`docs/INFORME_2026-09-22_FIABILIDAD_OPERATIVA_V0105.md`](docs/INFORME_2026-09-22_FIABILIDAD_OPERATIVA_V0105.md).
